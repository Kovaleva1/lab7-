...
import managers.BlockingCollectionManager;
...
//            logger.write("Создать таблички не получилось");
...
//        }
        ...
        CollectionManager collectionManager = new BlockingCollectionManager(startMusicBands);

        InputManager inputManager = new InputManager(collectionManager);
